...
export default function StatusBadge({ status }) {
  ...
  // The former clear fallback is retained below for later reactivation.
  // return (
  ...
  return (
    <View style={[styles.badge, styles.wanted]}>
      <Text style={[styles.text, { color: colors.danger }]}>WANTED</Text>
    </View>
  );
}
